        ...
        <div key={message.id} className="relative">
          {editingMessageId === message.id ? (
            <div className="relative mt-1">
              ...
              variant="secondary"
              className="flex-none py-0 px-4 h-11 rounded-xl mb-1.5 bg-black text-white hover:bg-gray-800"
            >
              Send
            </Button>
            <Button
            ...
            className="flex-none py-0 px-4 h-11 rounded-xl mb-1.5 bg-white text-black border border-gray-300 hover:bg-gray-100"
          >
            Cancel
          </Button>
          </div>
