...
function Sidebar() {
  ...
  return (
    <div
      className={`left-0 top-0 z-[1000] h-[100dvh] md:h-screen flex flex-col transition-all duration-300 overflow-hidden ${
      ...
      {isSidebarOpen ? (
        <div className="flex flex-col h-full">
          <div className="flex items-center justify-between pt-2 px-4 gap-2">
            <div className="relative flex-1" data-tour="sidebar-search">
              <InputBox
                placeholder="Search..."
                variant="primary"
                onChange={(value) => {
          ...
          <div ref={sidebarListRef} data-tour="sidebar-history" className="flex-1 overflow-y-auto p-4">
