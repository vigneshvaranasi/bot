...
def create_support_crew():
    """Create support crew with configured agents"""
    return Crew(
...
def create_conversation_summary_crew():
    """Create conversation summary crew with configured agents"""
    return Crew(
...
def create_conversation_title_crew():
    """Create conversation title crew with configured agents"""
    return Crew(
...
conversation_summary_crew = create_conversation_summary_crew()
conversation_title_generation_crew = create_conversation_title_crew()