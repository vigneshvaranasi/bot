...
def test_embeddings():
    ...
    print("1️⃣ Testing Sentence Transformers Embeddings:")
    try:
    ...
    print("2️⃣ Testing Gemini Embeddings:")
    ...
    if gemini_api_key:
        ...
        print("   ⚠️ No Gemini API key found (GOOGLE_API_KEY or GEMINI_API_KEY)")
        print("   💡 To test Gemini embeddings, set your API key in .env file\n")
    
    # Test 3: Batch embeddings
    print("3️⃣ Testing Batch Embeddings:")
    try:
